...
def find_number_of_search_pages(pn=1, q=question, r=remote, s=salary_price, ws=with_salary, u=url, rt="all"):
    ...
    browser.get(u + f'?page={pn}&q={q}&remote={r}&salary={s}&type={rt}&with_salary={ws}')
